...
var animal = {species: "monkey", name: "Bobo", age: 20, gender: "male", favoriteFood: "bananas", speech: function(){return "Bobo says hello"}};
...
var cars = [{make: "Audi", model: "A4", year: 2005}, {make: "Toyota", model: "Corolla", year: 1992}, {make: "Ford", model: "Escort", year: 1997}];
...
var findModels = function (cars) {
  var newArray = [];
  for(i=0; i<cars.length; i++){
    newArray.push(cars[i].model);
}
return newArray;
};
